...
namespace AudioUlawEncodeDecode02 {
    class AudioUlawEncodeDecode02 {
        static int value = 0;
        ...
        static void processAndDisplayTruncation() {
            while ((shortValue >= 0) &
                ...
                Console.Write(shortValue + " ");
                Console.Write(result + " ");
                Console.Write(shortValue - result);
                if (shortValue > 0) {
                    Console.WriteLine(" " +
