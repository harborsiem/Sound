...
typedef void (__stdcall *AddAudioFormat)(INT32 significantBits, INT32 frameSizeInBytes,
                               INT32 channels, float sampleRate,
                               INT32 encoding, INT32 isSigned,
                               INT32 bigEndian);
...
void DAUDIO_AddAudioFormat(AddAudioFormat callback, int significantBits, int frameSizeInBytes,
...
void DAUDIO_GetFormats(INT32 mixerIndex, INT32 deviceID, int isSource, AddAudioFormat callback);
