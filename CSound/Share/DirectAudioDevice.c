...
void DAUDIO_AddAudioFormat(AddAudioFormat function, int significantBits, int frameSizeInBytes,
	...
	int bigEndian)
{
	...
	(function)(significantBits, frameSizeInBytes,
...
*/
DllExport void __stdcall DirectAudioDevice_nGetFormats(INT32 mixerIndex, INT32 deviceID, INT32 isSource, AddAudioFormat callback) {
	...
	//} else {
	DAUDIO_GetFormats((INT32)mixerIndex, (INT32)deviceID, (int)isSource, callback);
	//}
#endif
}
...
*/
DllExport UINT_PTR __stdcall DirectAudioDevice_nOpen(
	INT32 mixerIndex, INT32 deviceID, INT32 isSource,
	INT32 encoding, float sampleRate, INT32 sampleSizeInBits, INT32 frameSize, INT32 channels,
	INT32 isSigned, INT32 isBigendian, INT32 bufferSizeInBytes) {
...
* Signature: (JZ)V
*/
DllExport void __stdcall DirectAudioDevice_nStart(UINT_PTR id, INT32 isSource) {
#if USE_DAUDIO == TRUE
...
* Signature: (JZ)V
*/
DllExport void __stdcall DirectAudioDevice_nStop(UINT_PTR id, INT32 isSource) {
#if USE_DAUDIO == TRUE
	DAUDIO_Info* info = (DAUDIO_Info*)(UINT_PTR)id;
	if (info && info->handle) {
...
* Signature: (JZ)V
*/
DllExport void __stdcall DirectAudioDevice_nClose(UINT_PTR id, INT32 isSource) {
#if USE_DAUDIO == TRUE
	DAUDIO_Info* info = (DAUDIO_Info*)(UINT_PTR)id;
	if (info && info->handle) {
...
* Signature: (J[BII)I
*/
DllExport INT32 __stdcall DirectAudioDevice_nWrite(
	UINT_PTR id, UINT8* jData,
	INT32 offset, INT32 len, INT32 conversionSize, float leftGain, float rightGain) {
	int ret = -1;
#if USE_DAUDIO == TRUE
	UINT8* data;
	UINT8* dataOffset;
	...
	if (len == 0) return 0;
	if (info && info->handle) {
		data = (UINT8*)jData; //((*env)->GetByteArrayElements(env, jData, &didCopy));
...
* Signature: (J[BII)I
*/
DllExport INT32 __stdcall DirectAudioDevice_nRead(UINT_PTR id, char* jData, INT32 offset, INT32 len, INT32 conversionSize) {
	int ret = -1;
#if USE_DAUDIO == TRUE
	char* data;
	char* dataOffset;
	...
	if (info && info->handle) {
		data = (char*)jData; // ((*env)->GetByteArrayElements(env, jData, NULL));
		CHECK_NULL_RETURN(data, ret);
		dataOffset = data;
		dataOffset += (int)offset;
...
* Signature: (JZ)I
*/
DllExport INT32 __stdcall DirectAudioDevice_nGetBufferSize(UINT_PTR id, INT32 isSource) {
	int ret = -1;
#if USE_DAUDIO == TRUE
	DAUDIO_Info* info = (DAUDIO_Info*)(UINT_PTR)id;
	if (info && info->handle) {
...
* Signature: (JZ)Z
*/
DllExport INT32 __stdcall DirectAudioDevice_nIsStillDraining(UINT_PTR id, INT32 isSource) {
	int ret = FALSE;
#if USE_DAUDIO == TRUE
	DAUDIO_Info* info = (DAUDIO_Info*)(UINT_PTR)id;
	if (info && info->handle) {
...
* Signature: (JZ)V
*/
DllExport void __stdcall DirectAudioDevice_nFlush(UINT_PTR id, INT32 isSource) {
#if USE_DAUDIO == TRUE
	DAUDIO_Info* info = (DAUDIO_Info*)(UINT_PTR)id;
	if (info && info->handle) {
...
* Signature: (JZ)I
*/
DllExport INT32 __stdcall DirectAudioDevice_nAvailable(UINT_PTR id, INT32 isSource) {
	int ret = -1;
#if USE_DAUDIO == TRUE
	DAUDIO_Info* info = (DAUDIO_Info*)(UINT_PTR)id;
	if (info && info->handle) {
...
* Signature: (JZJ)J
*/
DllExport INT64 __stdcall DirectAudioDevice_nGetBytePosition(UINT_PTR id, INT32 isSource, INT64 javaBytePos) {
...
* Signature: (JZJ)V
*/
DllExport void __stdcall DirectAudioDevice_nSetBytePosition(UINT_PTR id, INT32 isSource, INT64 pos) {
#if USE_DAUDIO == TRUE
	DAUDIO_Info* info = (DAUDIO_Info*)(UINT_PTR)id;
	if (info && info->handle) {
...
* Signature: (JZ)B
*/
DllExport INT32 __stdcall DirectAudioDevice_nRequiresServicing(UINT_PTR id, INT32 isSource) {
	int ret = FALSE;
#if USE_DAUDIO == TRUE
	DAUDIO_Info* info = (DAUDIO_Info*)(UINT_PTR)id;
	if (info && info->handle) {
...
* Signature: (JZ)V
*/
DllExport void __stdcall DirectAudioDevice_nService(UINT_PTR id, INT32 isSource) {
#if USE_DAUDIO == TRUE
	DAUDIO_Info* info = (DAUDIO_Info*)(UINT_PTR)id;
	if (info && info->handle) {
