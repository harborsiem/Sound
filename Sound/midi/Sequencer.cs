 ...
 */
    public interface ISequencer : IMidiDevice {
         ...
         */
        new long getMicrosecondPosition(); //a@
         ...
         * @see ControllerEventListener
         */
        int[] addControllerEventListener(IControllerEventListener listener,
                                         int[] controllers);
         ...
         */
        int[] removeControllerEventListener(IControllerEventListener listener,
                                            int[] controllers);
    ...
    public abstract class Sequencer {
         ...
         * @since 1.5
         */
        public const int LOOP_CONTINUOUSLY = -1;
        ...
        public class SyncMode {
             ...
             * mode.
             */
            public static readonly SyncMode INTERNAL_CLOCK = new SyncMode("Internal Clock");
             ...
             * note.
             */
            public static readonly SyncMode MIDI_SYNC = new SyncMode("MIDI Sync");
             ...
             */
            public static readonly SyncMode MIDI_TIME_CODE = new SyncMode("MIDI Time Code");
             ...
             */
            public static readonly SyncMode NO_SYNC = new SyncMode("No Timing");
        }
    }
}
