 ...
 */
    ...
    public class ShortMessage : MidiMessage {
         ...
         * @see MidiMessage#getStatus
         */
        public const int END_OF_EXCLUSIVE = 0xF7; // 247
         ...
         * @see MidiMessage#getStatus
         */
        public const int CONTINUE = 0xFB; // 251
        ...
        protected internal ShortMessage(byte[] data)
        ...
        public virtual void setMessage(int command, int channel, int data1, int data2) {
            ...
            if (command >= 0xF0 || command < 0x80) {
                throw new InvalidMidiDataException("command out of range: 0x" + command.ToString("X", CultureInfo.InvariantCulture));
            }
         ...
         */
        protected internal int getDataLength(int status) {
