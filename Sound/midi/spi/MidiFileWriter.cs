 ...
 */
    public abstract class MidiFileWriter {
         ...
         *         {@code false}
         */
        public virtual bool isFileTypeSupported(int fileType) {
         ...
         * @throws NullPointerException if {@code sequence} is {@code null}
         */
        public virtual bool isFileTypeSupported(int fileType, Sequence sequence) {
         ...
         */
        public abstract int write(Sequence input, int fileType, Stream output);
         ...
         * @see #getMidiFileTypes(Sequence)
         */
        public abstract int write(Sequence input, int fileType, FileInfo output);
    }
}
