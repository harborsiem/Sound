 ...
 */
    public interface IMidiDevice : IAutoCloseable {
         ...
         * @since 1.5
         */
        IList<ITransmitter> getTransmitters();
    }
    ...
    public abstract class MidiDevice {
        ...
        public class Info {
             ...
             */
            protected internal Info(String name, String vendor, String description,
                                    String version) {
             ...
             */
            public String getVendor() { //sealed
                return vendor;
            }
             ...
             */
            public String getDescription() { //sealed
                return description;
            }
             ...
             */
            public String getVersion() { //sealed
                return version;
            }
