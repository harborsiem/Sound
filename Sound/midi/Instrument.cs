 ...
 */
    public abstract class Instrument : SoundbankResource {
         ...
         * @see Synthesizer#loadInstrument(Instrument)
         */
        protected internal Instrument(ISoundbank soundbank, Patch patch, String name, Type dataClass)

            : base(soundbank, name, dataClass) {
            this.patch = patch;
        }
