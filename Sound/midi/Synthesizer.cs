 ...
 * @see MidiDevice
 */
    public interface ISynthesizer : IMidiDevice {
         ...
         */
        bool isSoundbankSupported(ISoundbank soundbank);
         ...
         * @see MidiChannel#programChange(int, int)
         */
        bool loadInstrument(Instrument instrument);
         ...
         * @see #loadAllInstruments
         */
        bool remapInstrument(Instrument from, Instrument to);
         ...
         */
        ISoundbank getDefaultSoundbank();
         ...
         * @see #loadInstruments
         */
        bool loadAllInstruments(ISoundbank soundbank);
         ...
         * @see #unloadInstruments
         */
        void unloadAllInstruments(ISoundbank soundbank);
         ...
         */
        bool loadInstruments(ISoundbank soundbank, Patch[] patchList);
         ...
         * @see #loadInstruments
         */
        void unloadInstruments(ISoundbank soundbank, Patch[] patchList);
         ...
         */
        // Control getControl(Type controlClass);
    }
}
