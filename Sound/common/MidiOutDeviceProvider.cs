 ...
 */
    public sealed partial class MidiOutDeviceProvider : AbstractMidiDeviceProvider {
        ...
        public override AbstractMidiDeviceProvider.Info createInfo(int index) {
            ...
            return new MidiOutDeviceInfo(index, typeof(MidiOutDeviceProvider));
        }

        public override IMidiDevice createDevice(AbstractMidiDeviceProvider.Info info) {
            if (enabled && (info is MidiOutDeviceInfo)) {
        ...
        public override void setDeviceCache(IMidiDevice[] devices) { MidiOutDeviceProvider.devices = devices; }
        public override Info[] getInfoCache() { return infos; }
        public override void setInfoCache(Info[] infos) { MidiOutDeviceProvider.infos = infos; }
         ...
         */
        internal sealed class MidiOutDeviceInfo : AbstractMidiDeviceProvider.Info {
            private readonly Type providerClass;

            internal MidiOutDeviceInfo(int index, Type providerClass)
