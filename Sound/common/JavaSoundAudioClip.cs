...
namespace SystemX.Media.Sound {
     ...
     */
    public sealed class JavaSoundAudioClip : IMetaEventListener, ILineListener, IDisposable {
        ...
        private bool daemonThread = false;
        ...
        public static JavaSoundAudioClip create(FileInfo file) {
        ...
        //public static SoundClip create(URLConnection uc) {
        //    JavaSoundAudioClip clip = new JavaSoundAudioClip();
        //    FileInfo tmpFile = null;
        //    try {
        //        tmpFile = FileInfo.createTempFile("javaurl", ".aud");
        //    } catch (IOException e) {
        //        return null;
        //    }
        //    InputStream input;
        ...
        public static JavaSoundAudioClip create(Uri url) {
            JavaSoundAudioClip clip = new JavaSoundAudioClip();
            try {
                clip.init(UrlHelper.openStream(url));
            } catch (Exception) {
        ...
        //~JavaSoundAudioClip() { //protected void finalize() {
        //    Dispose(false);
        //}
