 ...
 */
    public sealed class WaveFileReader : SunFileReader {
        ...
        internal override StandardFileFormat getAudioFileFormatImpl(Stream stream) {
            ...
            //       This fixes #4257986
            if (endLength > nread) {
                b = dis.ReadBytes(endLength - nread);
                nread += b.Length;
            }
