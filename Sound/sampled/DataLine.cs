        ...
        public class Info : Line.Info {
            ...
            public Info(Type lineClass, AudioFormat[] formats, int minBufferSize, int maxBufferSize)
                ...
                if (formats == null) {
                    ...
                    AudioFormat[] temp = new AudioFormat[formats.Length];
                    Array.Copy(formats, temp, formats.Length);
                    this.formats = temp;
                }
             ...
             */
            public Info(Type lineClass, AudioFormat format, int bufferSize)
             ...
             * @param  format desired format
             */
            public Info(Type lineClass, AudioFormat format)
            ...
            public AudioFormat[] getFormats() {
                ...
                Array.Copy(formats, 0, returnedArray, 0, formats.Length);
            ...
            public override String ToString() {
                ...
                return String.Format("{0}{1}{2}", base.ToString(), format, buffers);
            }
        }
    }
}
