 ...
 * @since 1.3
 */
    public abstract class FloatControl : Control {
         ...
         */
        private readonly String midLabel;
         ...
         *         allowable range
         */
        protected internal FloatControl(Type type, float minimum, float maximum,
            ...
            if (minimum > maximum) {
                throw new ArgumentException("Minimum value " + minimum
                        + " exceeds maximum value " + maximum + ".");
            }
            if (initialValue < minimum) {
                throw new ArgumentException("Initial value " + initialValue
        ...
        public virtual void setValue(float newValue) {
            ...
            if (newValue > maximum) {
                throw new ArgumentException("Requested value " + newValue + " exceeds allowable maximum value " + maximum + ".");
            }

            if (newValue < minimum) {
                throw new ArgumentException("Requested value " + newValue + " smaller than allowable minimum value " + minimum + ".");
            }
        ...
        public void shift(float from, float to, int microseconds) {
            ...
            if (from < minimum) {
                throw new ArgumentException("Requested value " + from
                        + " smaller than allowable minimum value " + minimum + ".");
            }
            if (from > maximum) {
                throw new ArgumentException("Requested value " + from
        ...
        public override String ToString() {
            return String.Format("{0} with current value: {1} {2} (range: {3} - {4})",
                                 base.ToString(), getValue(), getUnits(),
         ...
         * @since 1.3
         */
        public new class Type : Control.Type {
             ...
             * @see #VOLUME
             */
            public static readonly Type MASTER_GAIN = new Type("Master Gain");
             ...
             * @see #AUX_RETURN
             */
            public static readonly Type AUX_SEND = new Type("AUX Send");
             ...
             * @see #AUX_SEND
             */
            public static readonly Type AUX_RETURN = new Type("AUX Return");
             ...
             */
            public static readonly Type REVERB_SEND = new Type("Reverb Send");
             ...
             * @see #REVERB_SEND
             */
            public static readonly Type REVERB_RETURN = new Type("Reverb Return");
             ...
             */
            public static readonly Type VOLUME = new Type("Volume");
             ...
             * @see #BALANCE
             */
            public static readonly Type PAN = new Type("Pan");
             ...
             * @see #PAN
             */
            public static readonly Type BALANCE = new Type("Balance");
             ...
             */
            public static readonly Type SAMPLE_RATE = new Type("Sample Rate");
             ...
             */
            public Type(String name) //a@ wegen Gervill von protected auf public
                : base(name) {
            }
        }
    }
