 ...
 */
    public class LineEvent : EventObject {
         ...
         */
        private const long serialVersionUID = -1274246333383880410L;
         ...
         */
        public LineEvent(ILine line, Type type, long position)
            : base(line) {
            this.type = type;
        ...
        public override String ToString() {
            return String.Format("{0} event from line {1}", type, getLine());
        }
        ...
        public class Type {
             ...
             * @see Line#open
             */
            public static readonly Type OPEN = new Type("Open");
             ...
             * @see Line#close
             */
            public static readonly Type CLOSE = new Type("Close");
             ...
             * @see DataLine#start
             */
            public static readonly Type START = new Type("Start");
             ...
             * @see DataLine#stop
             */
            public static readonly Type STOP = new Type("Stop");
