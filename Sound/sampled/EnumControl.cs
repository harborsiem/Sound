 ...
 * @since 1.3
 */
    public abstract class EnumControl : Control {
         ...
         */
        protected internal EnumControl(Type type, Object[] values, Object value)
            : base(type) {
            this.values = values;
            this.value = value;
        }
        ...
        public virtual void setValue(Object value) {
            if (!isValueSupported(value)) {
                throw new ArgumentException("Requested value " + value + " is not supported.");
            }
         ...
         */
        private bool isValueSupported(Object value) {
        ...
        public new class Type : Control.Type {
             ...
             * {@code REVERB}.)
             */
            public static readonly Type REVERB = new Type("Reverb");
