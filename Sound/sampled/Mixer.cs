 ...
 */
    public interface IMixer : ILine {
         ...
         *         mixer.
         */
        void synchronize(ILine[] lines, bool maintainSync);
         ...
         *         established.
         */
        void unsynchronize(ILine[] lines);
         ...
         *         otherwise
         */
        bool isSynchronizationSupported(ILine[] lines, bool maintainSync);
    }
    ...
    public abstract class Mixer {
        ...
        public class Info {
             ...
             */
            protected internal Info(String name, String vendor, String description, String version) {
