 ...
 */
    public class ReverbType {
         ...
         */
        private readonly int earlyReflectionDelay;

        /**
         * Early reflection intensity.
         */
        private readonly float earlyReflectionIntensity;

        /**
         * Late reflection delay in microseconds.
         */
        private readonly int lateReflectionDelay;

        /**
         * Late reflection intensity.
         */
        private readonly float lateReflectionIntensity;

        /**
         * Total decay time.
         */
        private readonly int decayTime;
         ...
         */
        protected internal ReverbType(String name, int earlyReflectionDelay, float earlyReflectionIntensity, int lateReflectionDelay,
        ...
        public sealed override String ToString() {
            return String.Format("{0}, early reflection delay {1:d} ns, " +
                                 "early reflection intensity {2} dB, " +
                                 "late deflection delay {3:d} ns, " +
                                 "late reflection intensity {4} dB, decay time {5:d}",
