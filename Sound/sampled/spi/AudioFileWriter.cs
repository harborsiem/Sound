 ...
 */
    public abstract class AudioFileWriter {
         ...
         */
        public abstract int write(AudioInputStream stream, AudioFileFormat.Type fileType, Stream output);
         ...
         * @see #getAudioFileTypes
         */
        public abstract int write(AudioInputStream stream, AudioFileFormat.Type fileType, FileInfo output);
    }
}
