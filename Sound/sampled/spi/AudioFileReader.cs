 ...
 */
    public abstract class AudioFileReader {
         ...
         */
        public abstract AudioFileFormat getAudioFileFormat(Stream stream);
         ...
         */
        public abstract AudioFileFormat getAudioFileFormat(Uri url);
         ...
         */
        public abstract AudioFileFormat getAudioFileFormat(FileInfo file);
         ...
         * @see InputStream#mark
         */
        public abstract AudioInputStream getAudioInputStream(Stream stream);
         ...
         * @throws NullPointerException if {@code url} is {@code null}
         */
        public abstract AudioInputStream getAudioInputStream(Uri url);
         ...
         * @throws NullPointerException if {@code file} is {@code null}
         */
        public abstract AudioInputStream getAudioInputStream(FileInfo file);
    }
}
