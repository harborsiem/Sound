 ...
 */
    public class AudioInputStream : InputStream {
         ...
         */
        protected internal long frameLength;
         ...
         */
        protected internal long framePos;
         ...
         */
        public AudioInputStream(Stream stream, AudioFormat format, long length)
         ...
         */
        public AudioInputStream(ITargetDataLine line) {
        ...
        public override long Position {
            get { return this.framePos * this.frameSize; }
        }
        ...
        public override long Length {
            get {
                if (this.frameLength == AudioSystem.NOT_SPECIFIED) {
                    ...
                    return this.frameLength * this.frameSize;
                }
            }
        }
        ...
        public override int ReadByte() {
            ...
            int temp = Read(data, 0, data.Length);
            if (temp <= 0) {
        ...
        public override int Read(byte[] b, int off, int len) {
            ...
            if (bytesRead > 0) {
                ...
                if (pushBackLen > 0) {
                    ...
                    Array.Copy(b, off + bytesRead - pushBackLen,
         ...
         */
        private class TargetDataLineInputStream : InputStream {

            /**
             * The TargetDataLine on which this TargetDataLineInputStream is based.
             */
            ITargetDataLine line;


            internal TargetDataLineInputStream(ITargetDataLine line)
                : base() {
                this.line = line;
            }

            public override long Position {
                get { return (this.Length - available()); }
            }

            public override long Length {
                get { return line.getBufferSize(); }
            }
