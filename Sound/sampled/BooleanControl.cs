 ...
 */
    public abstract class BooleanControl : Control {
         ...
         */
        private readonly String trueStateLabel;

        /**
         * The {@code false} state label, such as "false" or "off".
         */
        private readonly String falseStateLabel;
         ...
         */
        protected internal BooleanControl(Type type, bool initialValue, String trueStateLabel, String falseStateLabel)
         ...
         * @param  initialValue the initial control value
         */
        protected internal BooleanControl(Type type, bool initialValue)
         ...
         */
        public String getStateLabel(bool state) {
        ...
        public override String ToString() {
            return String.Format("{0} with current value: {1}", base.ToString(),
        ...
        public new class Type : Control.Type {
             ...
             */
            public static readonly Type MUTE = new Type("Mute");
             ...
             */
            public static readonly Type APPLY_REVERB = new Type("Apply Reverb");
             ...
             */
            protected internal Type(String name)
                : base(name) {
            }
        }
    }
