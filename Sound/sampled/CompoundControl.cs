 ...
 */
    public abstract class CompoundControl : Control {
         ...
         */
        protected internal CompoundControl(Type type, Control[] memberControls)
            : base(type) {
        ...
        public override String ToString() {
            ...
            foreach (Control control in getMemberControls()) {
                controlsList.Add(control.getType().ToString());
            }
            String controls = "[" + String.Join(", ", controlsList) + "]";
            return String.Format("{0} containing {1} controls", base.ToString(),
                                 controls);
        }
