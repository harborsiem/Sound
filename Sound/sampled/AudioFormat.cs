 ...
 */
    public class AudioFormat {
         ...
         * this format.
         */
        protected internal float sampleRate;

        /**
         * The number of bits in each sample of a sound that has this format.
         */
        protected internal int sampleSizeInBits;
         ...
         * this format.
         */
        protected internal float frameRate;
        ...
        public AudioFormat(Encoding encoding, float sampleRate, int sampleSizeInBits,
                           int channels, int frameSize, float frameRate, bool bigEndian) {
        ...
        public AudioFormat(Encoding encoding, float sampleRate,
                   ...
                   bool bigEndian, IDictionary<String, Object> properties)
        ...
        public AudioFormat(float sampleRate, int sampleSizeInBits,
                   int channels, bool signed, bool bigEndian)
        ...
        public override String ToString() {
            ...
            switch (getChannels()) {
                ...
                case AudioSystem.NOT_SPECIFIED:
                    channels = "unknown number of channels";
                    break;
                default:
            ...
            return String.Format("{0} {1}, {2}, {3}, {4}{5}{6}", getEncoding(),
        ...
        public class Encoding {
             ...
             */
            public static readonly Encoding PCM_SIGNED = new Encoding("PCM_SIGNED");

            /**
             * Specifies unsigned, linear PCM data.
             */
            public static readonly Encoding PCM_UNSIGNED = new Encoding("PCM_UNSIGNED");
             ...
             * @since 1.7
             */
            public static readonly Encoding PCM_FLOAT = new Encoding("PCM_FLOAT");

            /**
             * Specifies u-law encoded data.
             */
            public static readonly Encoding ULAW = new Encoding("ULAW");

            /**
             * Specifies a-law encoded data.
             */
            public static readonly Encoding ALAW = new Encoding("ALAW");
