 ...
 * @since 1.3
 */
    public interface ILine : IAutoCloseable {
         ...
         * @see LineEvent
         */
        new void close(); //a@ in IAutoCloseable
         ...
         * @see LineEvent
         */
        void addLineListener(ILineListener listener);
         ...
         * @see #addLineListener
         */
        void removeLineListener(ILineListener listener);
    }
    ...
    public abstract class Line {
        ...
        public class Info {
             ...
             */
            private readonly Type lineClass;
             ...
             */
            public Info(Type lineClass) {

                if (lineClass == null) {
                    this.lineClass = typeof(ILine);
                } else {
             ...
             */
            public virtual bool matches(Line.Info info) {
                ...
                if (!(this.GetType().IsInstanceOfType(info))) {
                    return false;
                }
            ...
            //    String str = getLineClass().ToString();
            ...
            //return str;
                ...
                String fullPackagePath = "SystemX.Sound.Sampled."; //a@@
                String initialString = getLineClass().ToString();
                String finalString;

                int index = initialString.IndexOf(fullPackagePath, StringComparison.Ordinal);
