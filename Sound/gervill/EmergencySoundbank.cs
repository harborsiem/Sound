 ...
 */
    public sealed class EmergencySoundbank {

        private static readonly String[] general_midi_instruments = {
        ...
        public static SF2Soundbank createSoundbank() {
            ...
            for (int i = 0; i < drums.Length; i++) {
                if (drums[i] != null) {
                    region = new SF2InstrumentRegion();
            ...
            region = slow_strings.getRegions()[0];
            ...
            foreach (SF2Instrument instrument in sf2.getInstruments()) {
        ...
        public static SF2Layer new_bell(SF2Soundbank sf2) {
            ...
            for (int i = 0; i < 40; i++) {
                ...
                complexGaussianDist(data, basis * (i + 1) * detune, w, a);
                a *= a_step;
            }
            SF2Sample sample = newSimpleFFTSample(sf2, "EPiano", data, basis);
            SF2Layer layer = newLayer(sf2, "EPiano", sample);
            SF2Region region = layer.getRegions()[0];
        ...
        public static SF2Layer new_guitar1(SF2Soundbank sf2) {
            ...
            for (int i = 0; i < 40; i++) {
                double w = start_w + (end_w - start_w) * (i / 40.0);
                complexGaussianDist(data, basis * (i + 1), w, aa[i]);
            }

            SF2Sample sample = newSimpleFFTSample(sf2, "Guitar", data, basis);
        ...
        public static SF2Layer new_gpiano(SF2Soundbank sf2) {
            ...
            for (int i = 0; i < 30; i++) {
                ...
                complexGaussianDist(data, basis * (i + 1) + adjust, w, ai);
            }

            SF2Sample sample = newSimpleFFTSample(sf2, "Grand Piano", data, basis, 200);
        ...
        public static SF2Layer new_piano1(SF2Soundbank sf2) {
            ...
            complexGaussianDist(data, basis * (15.5), 1, 0.1);
            complexGaussianDist(data, basis * (17.5), 1, 0.01);

            SF2Sample sample = newSimpleFFTSample(sf2, "EPiano", data, basis, 200);
            SF2Layer layer = newLayer(sf2, "EPiano", sample);
            SF2Region region = layer.getRegions()[0];
            region.putInteger(SF2Region.GENERATOR_SAMPLEMODES, 1);
            region.putInteger(SF2Region.GENERATOR_ATTACKVOLENV, -12000);
        ...
        public static SF2Layer new_bass1(SF2Soundbank sf2) {
            ...
            SF2Sample sample = newSimpleFFTSample(sf2, "Bass", data, basis);
        ...
        public static SF2Layer new_bass2(SF2Soundbank sf2) {
            ...
            SF2Sample sample = newSimpleFFTSample(sf2, "Bass2", data, basis);
        ...
        public static SF2Layer new_solostring(SF2Soundbank sf2) {
            ...
            for (int i = 0; i < aa.Length; i++) {
                double w = start_w + (end_w - start_w) * (i / 40.0);
                complexGaussianDist(data, basis * (i + 1), w, a);
            }
            SF2Sample sample = newSimpleFFTSample(sf2, "Strings", data, basis);
        ...
        public static SF2Layer new_orchhit(SF2Soundbank sf2) {
            ...
            complexGaussianDist(data, basis * 4, 300, 1);


            SF2Sample sample = newSimpleFFTSample(sf2, "Och Strings", data, basis);
        ...
        public static SF2Layer new_organ(SF2Soundbank sf2) {
            ...
            for (int i = 0; i < 12; i++) {
                double w = start_w + (end_w - start_w) * (i / 40.0);
                complexGaussianDist(data, basis * (i + 1), w,
                        a * (0.5 + 3 * (random.NextDouble())));
                a *= a_step;
            }
            SF2Sample sample = newSimpleFFTSample(sf2, "Organ", data, basis);
        ...
        public static SF2Layer new_flute(SF2Soundbank sf2) {
            ...
            complexGaussianDist(data, basis * 1, 0.001, 0.5);
            complexGaussianDist(data, basis * 2, 0.001, 0.5);
            complexGaussianDist(data, basis * 3, 0.001, 0.5);
            complexGaussianDist(data, basis * 4, 0.01, 0.5);

            complexGaussianDist(data, basis * 4, 100, 120);
            complexGaussianDist(data, basis * 6, 100, 40);
            complexGaussianDist(data, basis * 8, 100, 80);

            complexGaussianDist(data, basis * 5, 0.001, 0.05);
            complexGaussianDist(data, basis * 6, 0.001, 0.06);
            complexGaussianDist(data, basis * 7, 0.001, 0.04);
            complexGaussianDist(data, basis * 8, 0.005, 0.06);
            complexGaussianDist(data, basis * 9, 0.005, 0.06);
            complexGaussianDist(data, basis * 10, 0.01, 0.1);
            complexGaussianDist(data, basis * 11, 0.08, 0.7);
            complexGaussianDist(data, basis * 12, 0.08, 0.6);
            complexGaussianDist(data, basis * 13, 0.08, 0.6);
            complexGaussianDist(data, basis * 14, 0.08, 0.6);
            complexGaussianDist(data, basis * 15, 0.08, 0.5);
            complexGaussianDist(data, basis * 16, 0.08, 0.5);
            complexGaussianDist(data, basis * 17, 0.08, 0.2);


            complexGaussianDist(data, basis * 1, 10, 8);
            complexGaussianDist(data, basis * 2, 10, 8);
            complexGaussianDist(data, basis * 3, 10, 8);
            complexGaussianDist(data, basis * 4, 10, 8);
            complexGaussianDist(data, basis * 5, 10, 8);
            complexGaussianDist(data, basis * 6, 20, 9);
            complexGaussianDist(data, basis * 7, 20, 9);
            complexGaussianDist(data, basis * 8, 20, 9);
            complexGaussianDist(data, basis * 9, 20, 8);
            complexGaussianDist(data, basis * 10, 30, 8);
            complexGaussianDist(data, basis * 11, 30, 9);
            complexGaussianDist(data, basis * 12, 30, 9);
            complexGaussianDist(data, basis * 13, 30, 8);
            complexGaussianDist(data, basis * 14, 30, 8);
            complexGaussianDist(data, basis * 15, 30, 7);
            complexGaussianDist(data, basis * 16, 30, 7);
            complexGaussianDist(data, basis * 17, 30, 6);

            SF2Sample sample = newSimpleFFTSample(sf2, "Flute", data, basis);
        ...
        public static SF2Layer new_horn(SF2Soundbank sf2) {
            ...
            for (int i = 0; i < 40; i++) {
                if (i == 0)
                    complexGaussianDist(data, basis * (i + 1), 0.1, a * 0.2);
                else
                    complexGaussianDist(data, basis * (i + 1), 0.1, a);
                a *= a_step;
            }

            complexGaussianDist(data, basis * 2, 100, 1);


            SF2Sample sample = newSimpleFFTSample(sf2, "Horn", data, basis);
        ...
        public static SF2Layer new_trumpet(SF2Soundbank sf2) {
            ...
            for (int i = 0; i < 80; i++) {
                complexGaussianDist(data, basis * (i + 1), 0.1, aa[i]);
            }

            complexGaussianDist(data, basis * 5, 300, 3);


            SF2Sample sample = newSimpleFFTSample(sf2, "Trumpet", data, basis);
        ...
        public static SF2Layer new_brass_section(SF2Soundbank sf2) {
            ...
            double w = 5;
            for (int i = 0; i < 30; i++) {
                complexGaussianDist(data, basis * (i + 1), 0.1 * w, aa[i] * w);
                w += 6; //*= w_step;
            }

            complexGaussianDist(data, basis * 6, 300, 2);


            SF2Sample sample = newSimpleFFTSample(sf2, "Brass Section", data, basis);
        ...
        public static SF2Layer new_trombone(SF2Soundbank sf2) {
            ...
            SF2Sample sample = newSimpleFFTSample(sf2, "Trombone", data, basis);
        ...
        public static SF2Layer new_sax(SF2Soundbank sf2) {
            ...
            for (int i = 0; i < 40; i++) {
                if (i == 0 || i == 2)
                    complexGaussianDist(data, basis * (i + 1), 0.1, a * 4);
                else
                    complexGaussianDist(data, basis * (i + 1), 0.1, a);
                a *= a_step;
            }

            complexGaussianDist(data, basis * 4, 200, 1);

            SF2Sample sample = newSimpleFFTSample(sf2, "Sax", data, basis);
        ...
        public static SF2Layer new_oboe(SF2Soundbank sf2) {
            ...
            complexGaussianDist(data, basis * 5, 100, 80);


            complexGaussianDist(data, basis * 1, 0.01, 0.53);
            complexGaussianDist(data, basis * 2, 0.01, 0.51);
            complexGaussianDist(data, basis * 3, 0.01, 0.48);
            complexGaussianDist(data, basis * 4, 0.01, 0.49);
            complexGaussianDist(data, basis * 5, 0.01, 5);
            complexGaussianDist(data, basis * 6, 0.01, 0.51);
            complexGaussianDist(data, basis * 7, 0.01, 0.50);
            complexGaussianDist(data, basis * 8, 0.01, 0.59);
            complexGaussianDist(data, basis * 9, 0.01, 0.61);
            complexGaussianDist(data, basis * 10, 0.01, 0.52);
            complexGaussianDist(data, basis * 11, 0.01, 0.49);
            complexGaussianDist(data, basis * 12, 0.01, 0.51);
            complexGaussianDist(data, basis * 13, 0.01, 0.48);
            complexGaussianDist(data, basis * 14, 0.01, 0.51);
            complexGaussianDist(data, basis * 15, 0.01, 0.46);
            complexGaussianDist(data, basis * 16, 0.01, 0.35);
            complexGaussianDist(data, basis * 17, 0.01, 0.20);
            complexGaussianDist(data, basis * 18, 0.01, 0.10);
            complexGaussianDist(data, basis * 19, 0.01, 0.5);
            complexGaussianDist(data, basis * 20, 0.01, 0.1);


            SF2Sample sample = newSimpleFFTSample(sf2, "Oboe", data, basis);
        ...
        public static SF2Layer new_bassoon(SF2Soundbank sf2) {
            ...
            complexGaussianDist(data, basis * 2, 100, 40);
            complexGaussianDist(data, basis * 4, 100, 20);

            complexGaussianDist(data, basis * 1, 0.01, 0.53);
            complexGaussianDist(data, basis * 2, 0.01, 5);
            complexGaussianDist(data, basis * 3, 0.01, 0.51);
            complexGaussianDist(data, basis * 4, 0.01, 0.48);
            complexGaussianDist(data, basis * 5, 0.01, 1.49);
            complexGaussianDist(data, basis * 6, 0.01, 0.51);
            complexGaussianDist(data, basis * 7, 0.01, 0.50);
            complexGaussianDist(data, basis * 8, 0.01, 0.59);
            complexGaussianDist(data, basis * 9, 0.01, 0.61);
        ...
        public static SF2Layer new_clarinet(SF2Soundbank sf2) {
            ...
            complexGaussianDist(data, basis * 1, 0.001, 0.5);
            complexGaussianDist(data, basis * 2, 0.001, 0.02);
            complexGaussianDist(data, basis * 3, 0.001, 0.2);
            complexGaussianDist(data, basis * 4, 0.01, 0.1);

            complexGaussianDist(data, basis * 4, 100, 60);
            complexGaussianDist(data, basis * 6, 100, 20);
            complexGaussianDist(data, basis * 8, 100, 20);

            complexGaussianDist(data, basis * 5, 0.001, 0.1);
            complexGaussianDist(data, basis * 6, 0.001, 0.09);
            complexGaussianDist(data, basis * 7, 0.001, 0.02);
            complexGaussianDist(data, basis * 8, 0.005, 0.16);
            complexGaussianDist(data, basis * 9, 0.005, 0.96);
            complexGaussianDist(data, basis * 10, 0.01, 0.9);
            complexGaussianDist(data, basis * 11, 0.08, 1.2);
            complexGaussianDist(data, basis * 12, 0.08, 1.8);
            complexGaussianDist(data, basis * 13, 0.08, 1.6);
            complexGaussianDist(data, basis * 14, 0.08, 1.2);
            complexGaussianDist(data, basis * 15, 0.08, 0.9);
            complexGaussianDist(data, basis * 16, 0.08, 0.5);
            complexGaussianDist(data, basis * 17, 0.08, 0.2);
            ...
            SF2Sample sample = newSimpleFFTSample(sf2, "Clarinet", data, basis);
        ...
        public static SF2Layer new_timpani(SF2Soundbank sf2) {
            ...
            // Make Bass Part
            {
                ...
                double[] data = new double[2 * fftlen];
                double basis = 48;
                complexGaussianDist(data, basis * 2, 0.2, 1);
                complexGaussianDist(data, basis * 3, 0.2, 0.7);
                complexGaussianDist(data, basis * 5, 10, 1);
                complexGaussianDist(data, basis * 6, 9, 1);
                complexGaussianDist(data, basis * 8, 15, 1);
                complexGaussianDist(data, basis * 9, 18, 0.8);
                complexGaussianDist(data, basis * 11, 21, 0.5);
                complexGaussianDist(data, basis * 13, 28, 0.3);
                complexGaussianDist(data, basis * 14, 22, 0.1);
                randomPhase(data, new Random(3049912));
                ifft(data);
                normalize(data, 0.5);
                data = realPart(data);
        ...
        public static SF2Sample newSimpleFFTSample(SF2Soundbank sf2, String name,
                double[] data, double basis) {
            return newSimpleFFTSample(sf2, name, data, basis, 10);
        }

        public static SF2Sample newSimpleFFTSample(SF2Soundbank sf2, String name,
                double[] data, double basis, int fadeuptime) {

            int fftsize = data.Length / 2;
            AudioFormat format = new AudioFormat(44100, 16, 1, true, false);
            double basefreq = (basis / fftsize) * format.getSampleRate() * 0.5;
            ...
            sample.setPitchCorrection((byte)(sbyte)(-(orgnote - (int)orgnote) * 100.0));
        ...
        public static SF2Sample newSimpleFFTSample_dist(SF2Soundbank sf2,
                String name, double[] data, double basis, double preamp) {
        ...
        public static SF2Instrument newInstrument(SF2Soundbank sf2, String name,
                Patch patch, params SF2Layer[] layers) { //a@
        ...
        public static void randomPhase(double[] data) {
            for (int i = 0; i < data.Length; i += 2) {
                double phase = new Random().NextDouble() * 2 * Math.PI; //; Math.random()
                double d = data[i];
        ...
        public static double[] realPart(double[] input) {
        ...
        public static double[] imgPart(double[] input) {
            double[] output = new double[input.Length / 2];
            for (int i = 0; i < output.Length; i++) {
                output[i] = input[i * 2];
            }
        ...
        public static byte[] toBytes(float[] input, AudioFormat format) {
            byte[] output = new byte[input.Length * format.getFrameSize()];
            return AudioFloatConverter.getConverter(format).toByteArray(input, output);
        }
