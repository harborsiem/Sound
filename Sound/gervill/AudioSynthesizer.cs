 ...
 */
    public interface IAudioSynthesizer : ISynthesizer {
         ...
         */
        AudioSynthesizerPropertyInfo[] getPropertyInfo(IDictionary<String, Object> info);
         ...
         * @see #isOpen
         */
        void open(ISourceDataLine line, IDictionary<String, Object> info);
