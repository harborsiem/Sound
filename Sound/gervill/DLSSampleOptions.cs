 ...
 */
    public sealed class DLSSampleOptions {

        internal int unitynote;
        internal short finetune;
        internal int attenuation;
        internal long options;
        internal IList<DLSSampleLoop> loops = new List<DLSSampleLoop>();
        ...
        public IList<DLSSampleLoop> getLoops() {
            return loops;
        }
