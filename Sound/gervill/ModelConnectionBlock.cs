 ...
 */
    public sealed class ModelConnectionBlock {

        //
        //   source1 * source2 * scale -> destination
        //
        private static readonly ModelSource[] no_sources = new ModelSource[0];
