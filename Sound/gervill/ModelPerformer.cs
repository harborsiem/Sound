 ...
 */
    public sealed class ModelPerformer {

        private readonly List<IModelOscillator> oscillators = new List<IModelOscillator>();
        private IList<ModelConnectionBlock> connectionBlocks = new List<ModelConnectionBlock>();
        private int keyFrom = 0;
        private int keyTo = 127;
        private int velFrom = 0;
        private int velTo = 127;
        private int exclusiveClass = 0;
        private bool releaseTrigger = false;
        private bool selfNonExclusive = false;
        private Object userObject = null;
        private bool addDefaultConnections = true;
        ...
        public IList<ModelConnectionBlock> getConnectionBlocks() {
            return connectionBlocks;
        }

        public void setConnectionBlocks(IList<ModelConnectionBlock> connectionBlocks) {
            this.connectionBlocks = connectionBlocks;
        }

        public IList<IModelOscillator> getOscillators() {
            return oscillators;
        }
        ...
        public void setSelfNonExclusive(bool selfNonExclusive) {
        ...
        public void setReleaseTriggered(bool value) {
        ...
        public void setDefaultConnectionsEnabled(bool addDefaultConnections) {
