 ...
 */
    public abstract class ModelInstrument : Instrument {

        protected ModelInstrument(ISoundbank soundbank, Patch patch, String name,
                Type dataClass)
            : base(soundbank, patch, name, dataClass) {
        }

        public virtual IModelDirector getDirector(ModelPerformer[] performers,
                IMidiChannel channel, IModelDirectedPlayer player) {
            return new ModelStandardIndexedDirector(performers, player);
        }

        public virtual ModelPerformer[] getPerformers() {
            return new ModelPerformer[0];
        }

        public virtual IModelChannelMixer getChannelMixer(IMidiChannel channel,
                AudioFormat format) {
            return null;
        }
        ...
        public String[] getKeys() {
            ...
            foreach (ModelPerformer performer in getPerformers()) {
