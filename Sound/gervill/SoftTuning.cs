 ...
 */
    public sealed class SoftTuning {

        private String name = null;
        private readonly double[] tuning = new double[128];
        ...
        /*
        private bool checksumOK2(byte[] data) {
                    ...
                    case 0x08: // MIDI Tuning Standard
                        ...
                        switch (subid2) {
                            case 0x01: { // BULK TUNING DUMP (NON-REAL-TIME)
                                    ...
                                    name = Encoding.ASCII.GetString(data, 6, 16);
                                    for (int i = 0; i < 128; i++) {
                                        int xx = data[r++] & 0xFF;
                                        int yy = data[r++] & 0xFF;
                                        int zz = data[r++] & 0xFF;
                            ...
                            case 0x04: { // KEY-BASED TUNING DUMP (NON-REAL-TIME)
                                    ...
                                    name = Encoding.ASCII.GetString(data, 7, 16);
                                    r = 23;
                                    for (int i = 0; i < 128; i++) {
                                        int xx = data[r++] & 0xFF;
                                        int yy = data[r++] & 0xFF;
